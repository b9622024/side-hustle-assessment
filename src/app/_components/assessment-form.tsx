...
function ProfileStep({ draft, update }: { draft: Draft; update: <K extends keyof Draft>(key: K, value: Draft[K]) => void }) {
  ...
  return <div className="step-content"><StepHeading number="01" title="先認識你" description="出生資料會用於星座與生命靈數工作風格分析；實際副業適性仍以你的行為回答與目前狀態為主要依據。" /><div className="field-grid">
